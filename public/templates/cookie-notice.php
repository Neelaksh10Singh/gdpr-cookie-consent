...
<div id="<?php echo esc_html( $the_options['container_id'] ); ?>" class="<?php echo esc_html( $the_options['container_class'] ); ?> <?php echo esc_html( $the_options['theme_class'] ); ?>"  style="<?php echo esc_attr($notice_container_styles); ?>">	
	...
	<div class=" gdpr_main_body"  style="display: flex; flex-direction: <?php echo esc_attr($banner_layouts['c2']['direction'] ?? 'row') == 'col' ? ($banner_structure['c2'][0] === 'bannerText' ? 'column' : 'column-reverse') : ($banner_structure['c2'][0] === 'bannerText' ? 'row' : 'row-reverse'); ?>; <?php echo "gap: " . ($ab_testing_enabled === "true" ? $the_options['cookie_bar_spacing' . $chosenBanner] : $the_options["cookie_bar_spacing"]) . "px;"; echo $banner_layouts['c2']['direction'] == 'row' ? 'align-items:center;' : '' ;?>" >
		...
		<?php if ( $the_options['cookie_usage_for'] !== 'ccpa' ) : ?>
			<div class="gdpr group-description-buttons cookie_notice_buttons" style="margin-top: <?php echo esc_attr($banner_layouts['c2']['direction'] ?? 'row') == 'col' ? '5px' : '0px'; ?>; display: flex; flex-direction: <?php echo esc_attr($banner_layouts['c4']['direction'] ?? 'row') == 'col' ? 'column' : 'row'; ?>; <?php echo "gap: " . ($ab_testing_enabled === "true" ? $the_options['cookie_bar_spacing' . $chosenBanner] * 2 : $the_options["cookie_bar_spacing"] * 2) . "px;"; echo $banner_layouts['c2']['direction'] == 'row' ? 'width: 40%' : '' ;?>">
				<div class="left_buttons" style="display: <?php echo count($visible_c5_items) > 0 ? 'flex' : 'none'; ?>; flex-direction: <?php echo esc_attr($banner_layouts['c5']['direction'] ?? 'row') == 'col' ? 'column' : 'row'; ?>; <?php echo "gap: " . ($ab_testing_enabled === "true" ? $the_options['cookie_bar_spacing' . $chosenBanner] : $the_options["cookie_bar_spacing"]) * 2 . "px;"; ?> <?php echo $banner_layouts['c5']['direction'] === 'row' ? 'align-items: center; justify-content: ' . ($banner_layouts['c5']['justify'] ===  'between' ? 'space-between' : ($banner_layouts['c5']['justify'] ?? '')) : 'align-items: ' . ($banner_layouts['c5']['justify'] ?? '') ?>">
					<?php 
				...
				<div class="right_buttons" style="display: <?php echo count($visible_c6_items) > 0 ? 'flex' : 'none'; ?>;  flex-direction: <?php echo esc_attr($banner_layouts['c6']['direction'] ?? 'row') == 'col' ? 'column' : 'row'; ?>; <?php echo "gap: " . ($ab_testing_enabled === "true" ? $the_options['cookie_bar_spacing' . $chosenBanner] : $the_options["cookie_bar_spacing"]) * 2 . "px;"; ?> <?php echo $banner_layouts['c6']['direction'] === 'row' ? 'align-items: center; justify-content: ' . ($banner_layouts['c6']['justify'] ===  'between' ? 'space-between' : ($banner_layouts['c6']['justify'] ?? '')) : 'align-items: ' . ($banner_layouts['c6']['justify'] ?? '') ?>">
					<?php  
