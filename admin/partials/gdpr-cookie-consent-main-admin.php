			...
			<div class="wplp-compliance-main">
				...
				if ( ($is_user_connected == true && !$pro_installed) || $is_user_connected == false  ) {
						...
						<?php } else { ?>
							<div class="wplp-remaining-scan-header-left">
								<div class="wplp-scan-label" style="flex-direction: row;">
									<p><?php echo esc_html( 'Remaining Usage:', 'gdpr-cookie-consent' ); ?></p>
								</div>
							</div>	
						<?php } ?>
					...
					<?php if($gdpr_monthly_page_views_percent >= 80) { ?>
							<div class="gdpr-pageviews-notice-wrapper">
								<div class="gdpr-pageviews-notice-content">
									<svg width="63" height="59" viewBox="0 0 63 59" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M28.9463 4.14232C30.1182 2.24145 32.8818 2.24145 34.0537 4.14232L55.9598 39.6757C57.192 41.6744 55.7541 44.25 53.406 44.25H9.59396C7.24592 44.25 5.80804 41.6744 7.04025 39.6757L28.9463 4.14232Z" fill="#F1456A"/>
									...
									<div class="gdpr-pageviews-notice-text">
										...
										<p>You are nearing the limit of pageviews allowed. Kindly upgrade you plan to keep showing banner on your website</p>
										<?php } else { ?>
											<p>You have exhasuted the limit of pageviews on your site. The cookie notice has been disabled on your site. Kindly upgrade your plan to reenable the banner.</p>
										<?php } ?>
									</div>
								</div>
